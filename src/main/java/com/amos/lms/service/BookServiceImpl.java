...
public class BookServiceImpl implements BookService{
	...
	public Books saveBook(BookDTO bookDTO) {
		...
		Books books = new Books(bookDTO.getTitle(),bookDTO.getAuthors(),bookDTO.getIsbn(),bookDTO.getPublisher(),bookDTO.getPublication_date(),bookDTO.getEdition(),bookDTO.getLanguage(),bookDTO.getCategory(),bookDTO.getQuantity(),bookDTO.getStatus());
